...
dec= b"\x03\x2D\x10\x30" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x97\x77\x77\x77"  #00 00 00 00 
dec+=b"\x77\x77\x77\x77" + b"\x77\x77\x00\x00" + b"\x24\x18\xFF\xFE" + b"\x42\x42\x42\x42"  #00 00 00 10
dec+=b"\x42\x42\x42\x42" + b"\x42\x42\x42\x42" + b"\x42\x42\x42\x42" + b"\x42\x42\x00\x00"  #00 00 00 20
dec+=b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00"  #00 00 00 30
dec+=b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\xFF\xFE\x43\x00" + b"\x00\x00\x00\x00"  #00 00 00 40
dec+=b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00"  #00 00 00 50
'''
#decrypted mii qr code template    https://www.3dbrew.org/wiki/Mii
dec= b"\x03\x2D\x10\x30" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x97\x77\x77\x77"  #00 00 00 00 
dec+=b"\x77\x77\x77\x77" + b"\x77\x77\x00\x00" + b"\x24\x18\xFF\xFE" + b"\x42\x42\x0b\x00"  #00 00 00 10
dec+=b"\x42\x42\x42\x42" + b"\x42\x42\x42\x42" + b"\x42\x42\x42\x42" + b"\x42\x42\x00\x00"  #00 00 00 20
dec+=b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00"  #00 00 00 30
dec+=b"\x00\x00\x00\x00" + b"\x00\x00\x00\x00" + b"\xFE\xFF\x43\x00" + b"\x43\x00\x43\x00"  #00 00 00 40
dec+=b"\x43\x00\x43\x00" + b"\x43\x00\x43\x00" + b"\x43\x00\x43\x00" + b"\x43\x00\x43\x00"  #00 00 00 50
